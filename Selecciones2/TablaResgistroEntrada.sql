...
--Seleccion 2 de la tabla Registro Entradas
select * from registro_entrada where (fecha between '01/09/2026' and '30/09/2026') or (cedula_empleado like '17%')

select * from registro_entrada where fecha between '01/08/2026' and '30/08/2026' and cedula_empleado like '17%' and hora between '08:00' and '12:00'

select * from registro_entrada where (fecha between '01/08/2026' and '30/08/2026' and cedula_empleado like '17%' and hora between '08:00' and '12:00') or
(fecha between '01/09/2026' and '30/09/2026' and cedula_empleado like '08%' and hora between '09:00' and '13:00')